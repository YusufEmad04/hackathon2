...
st.set_page_config(page_title="Task Forces") 
...
with Marketing:
    ...
    with col3:
        ...
        text_area_text = st.text_area('Ask QIMA about this meeting' , key='uid99')
...
with Finance:
    ...
    with col3:
        ...
        text_area_text = st.text_area('Ask QIMA about this committee"s meetings')
        text_add_button = st.button('Ask', key="btn1")
...
with DiversityandInclusion:
    ...
    with col3:
        ...
        text_area_text = st.text_area('Ask QIMA about this meeting')
        text_add_button = st.button('Ask', key="btn2")
